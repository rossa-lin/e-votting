      ...
      <div class="kandidat">
        <div class="kandidat-isi">
          ...
          <div class="img-desk">
            ...
            <div class="deskripsi">
              <p>
                Saya memiliki visi untuk mewujudkan kelas yang tertib, disiplin,
                dan fokus dalam meraih prestasi. Untuk itu, saya akan berusaha
                menegakkan aturan kelas secara konsisten agar tercipta
                lingkungan belajar yang kondusif. Saya juga ingin meningkatkan
                kesadaran akan pentingnya tanggung jawab, dalam kehadiran,
                tugas, maupun sikap selama pembelajaran dan membantu teman-teman
                agar lebih fokus dan serius dalam belajar sehingga kita bisa
                mencapai hasil yang maksimal bersama.
              </p>
            </div>
          </div>
    ...
    <div class="popup">
      ...
      <div class="popup-content">
        ...
        <div class="popup-buttons">
          <a href="proses-vote.php?option_id=2" >Simpan</a>
          <a href="visi-misi-2.php" >Batal</a>
        </div>
      </div>
    </div>
  </body>
